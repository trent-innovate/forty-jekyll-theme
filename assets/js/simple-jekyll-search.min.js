...
! function() {
    ...
    ! function(e) {
        var r = {
                ...
                searchResultTemplate: '<article><span class="image"><img src="{{ post.image }}" alt="" /></span><header class="major"><h3><a href="{url}" class="link">{title}</a></h3><p>{synopsis}</p></header></article>',
